...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactArt = __webpack_require__(159);

	var _reactDom = __webpack_require__(190);

	var _reactDom2 = _interopRequireDefault(_reactDom);

	var _Synth = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(160); // Flip this to DOM mode for debugging

	var Transform = __webpack_require__(171);
	var Mode = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VML = __webpack_require__(161);
	var Canvas = __webpack_require__(180);
	var Base = __webpack_require__(184);
	...
	*/
	...
	__webpack_require__(179).setCurrent(exports);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Surface = __webpack_require__(162);
	exports.Path = __webpack_require__(167);
	exports.Shape = __webpack_require__(169);
	exports.Group = __webpack_require__(176);
	exports.ClippingRectangle = __webpack_require__(177);
	exports.Text = __webpack_require__(178);

	var DOM = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Class = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Class = __webpack_require__(163);
	var Dummy = __webpack_require__(175);
	var Native = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Base = __webpack_require__(170);
	var Path = __webpack_require__(167);
	var Surface = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Surface = __webpack_require__(181);
	exports.Path = __webpack_require__(182);
	exports.Shape = __webpack_require__(183);
	exports.Group = __webpack_require__(186);
	exports.ClippingRectangle = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SynthPanel = __webpack_require__(192);
	...
	var Synth = function (_Component) {
	    ...
	    function Synth() {
	        ...
	        _this._incrementActivePatch = function () {
	            var incremented = _this.state.activePatch + 1;
	            _this.setState({
	                activePatch: incremented === _this.state.patches.length ? 0 : incremented
	            });
	        };

	        _this._decrementActivePatch = function () {
	            var decremented = _this.state.activePatch - 1;
	            _this.setState({
	                activePatch: decremented < 0 ? _this.state.patches.length - 1 : decremented
	            });
	        };
	    ...
	    _createClass(Synth, [{
	        key: 'render',
	        value: function render() {
	            var activePatch = this.state.patches[this.state.activePatch];
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_SynthPanel2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Discrete = __webpack_require__(194);

	var _Discrete2 = _interopRequireDefault(_Discrete);

	var _Fader = __webpack_require__(195);

	var _Fader2 = _interopRequireDefault(_Fader);

	var _Dial = __webpack_require__(196);

	var _Dial2 = _interopRequireDefault(_Dial);

	var _FilterPanel = __webpack_require__(197);

	var _FilterPanel2 = _interopRequireDefault(_FilterPanel);

	var _Volume = __webpack_require__(198);
	...
	var DialControl = (0, _Control2.default)(_Dial2.default);
	var DialDiscreteControl = (0, _Control2.default)((0, _Discrete2.default)(_Dial2.default));
	var FaderControl = (0, _Control2.default)(_Fader2.default);
	var VolumeControl = (0, _Control2.default)(_Volume2.default);

	var SynthPanel = function (_React$Component) {
	    _inherits(SynthPanel, _React$Component);

	    function SynthPanel(props) {
	        _classCallCheck(this, SynthPanel);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SynthPanel).call(this, props));

	        _this._clearMouseMoveListeners = function () {
	            document.removeEventListener('mousemove', _this.state.currentListener);
	            _this.setState({
	        ...
	        _this._handleParamChange = function (key, val) {
	        ...
	        _this.currentListener = null;
	        _this.oscKeyToCentValue = [0, 34, 67, 100];
	        return _this;
	    }

	    _createClass(SynthPanel, [{
	        ...
	        value: function render() {
	            ...
	            var width = 960;
	            var height = 400;
	            var BORDER_PATH = (0, _reactArt.Path)().moveTo(0, 0).line(0, height).line(width, 0).line(0, -1 * height).close();

	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Header2.default, { title: this.state.title, incrementActivePatch: this.props.incrementActivePatch, decrementActivePatch: this.props.decrementActivePatch }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'synth-panel' },
	                    _react2.default.createElement(
	                        _reactArt.Surface,
	                        { top: 50, left: 50, width: 960, height: 243 },
	                        _react2.default.createElement(_reactArt.Shape, { fill: '#2e2f31', d: BORDER_PATH })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'main-panel' },
	                        _react2.default.createElement(DialDiscreteControl, { top: 37, left: 5, registerMouseMoveListener: this._registerMouseMoveListener, acuity: 2, currentValue: this.oscKeyToCentValue[this.state.osc] }),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'asdr' },
	                            _react2.default.createElement(FaderControl, { top: 0, left: 0, registerMouseMoveListener: this._registerMouseMoveListener, currentValue: this.state.attack, changeHandler: this._handleParamChange.bind(null, 'attack') }),
	                            _react2.default.createElement(FaderControl, { top: 0, left: 50, registerMouseMoveListener: this._registerMouseMoveListener, currentValue: this.state.sustain, changeHandler: this._handleParamChange.bind(null, 'sustain') }),
	                            _react2.default.createElement(FaderControl, { top: 0, left: 100, registerMouseMoveListener: this._registerMouseMoveListener, currentValue: this.state.delay, changeHandler: this._handleParamChange.bind(null, 'delay') }),
	                            _react2.default.createElement(FaderControl, { top: 0, left: 150, registerMouseMoveListener: this._registerMouseMoveListener, currentValue: this.state.release, changeHandler: this._handleParamChange.bind(null, 'release') })
	                        ),
	                        _react2.default.createElement(_FilterPanel2.default, { frequency: this.state.frequency, resonance: this.state.resonance }),
	                        _react2.default.createElement(DialControl, { top: 24, left: 670, registerMouseMoveListener: this._registerMouseMoveListener, changeHandler: this._handleParamChange.bind(null, 'frequency'), acuity: 5, currentValue: this.state.frequency }),
	                        _react2.default.createElement(DialControl, { top: 110, left: 670, registerMouseMoveListener: this._registerMouseMoveListener, changeHandler: this._handleParamChange.bind(null, 'resonance'), position: -130, acuity: 5, currentValue: this.state.resonance }),
	                        _react2.default.createElement(VolumeControl, { top: 24, left: 840, registerMouseMoveListener: this._registerMouseMoveListener, currentValue: 60 })
	                    )
	                )
	            );
	        }
	...
	SynthPanel.propTypes = {
	    activePatch: _react.PropTypes.object.isRequired,
	    incrementActivePatch: _react.PropTypes.func.isRequired,
	    decrementActivePatch: _react.PropTypes.func.isRequired
	};

	exports.default = SynthPanel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Control = function Control(WrappedComponent) {
	    var _class, _temp;
	    ...
	    return _temp = _class = function (_Component) {
	        ...
	        function _class(props) {
	            ...
	            _this._onMouseMove = function (e) {
	                var newRelY = _this.state.relY + (_this.state.lastY - e.pageY) / _this.props.acuity;
	                _this.setState({
	                    lastY: e.pageY,
	                    relY: _this._scaleParam(newRelY)
	                }, function () {
	                    if (typeof _this.props.changeHandler === 'function') {
	                        _this.props.changeHandler(_this.state.relY);
	                    }
	                });
	            };
	            ...
	            _this._handleMouseDown = function (e) {
	                ...
	                _this.setState({
	                    ...
	                    _this.props.registerMouseMoveListener(_this._onMouseMove);
	                });
	            };

	            _this._scaleParam = function (param) {
	                if (param < 0) {
	                    return 0;
	                } else if (param > 100) {
	                    return 100;
	        ...
	        _createClass(_class, [{
	            ...
	            value: function render() {
	                ...
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(WrappedComponent, { currentValue: this.state.relY, handleMouseDown: this._handleMouseDown })
	                );
	            }
	        }]);
	        ...
	        acuity: _react.PropTypes.number.isRequired,
	        registerMouseMoveListener: _react.PropTypes.func.isRequired,
	        currentValue: _react.PropTypes.number.isRequired,
	        changeHandler: _react.PropTypes.func
	    }, _class.defaultProps = {
	        acuity: 1
	    }, _temp;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Discrete = function Discrete(WrappedComponent) {
	    var _class, _temp2;
	    ...
	    return _temp2 = _class = function (_Component) {
	        ...
	        _createClass(_class, [{
	            ...
	            value: function render() {
	                ...
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'discrete-dial-wrapper' },
	                    _react2.default.createElement('div', { className: 'osc-type sine' }),
	                    _react2.default.createElement('div', { className: 'osc-type square' }),
	                    _react2.default.createElement('div', { className: 'osc-type triangle' }),
	                    _react2.default.createElement('div', { className: 'osc-type saw' }),
	                    _react2.default.createElement(WrappedComponent, _extends({ extraStyles: style }, this.props, { currentValue: this._discretise(this.props.currentValue) }))
	                );
	            }
	        }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Fader = function (_React$Component) {
	    _inherits(Fader, _React$Component);

	    function Fader() {
	        _classCallCheck(this, Fader);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Fader).apply(this, arguments));
	    }
	    ...
	    _createClass(Fader, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { style: faderWrapperStyle },
	                _react2.default.createElement('div', { className: 'faderSlit' }),
	                _react2.default.createElement('div', { style: faderStyle, onMouseDown: this.props.handleMouseDown })
	            );
	        }
	    }]);
	...
	Fader.propTypes = {
	    ...
	    left: _react.PropTypes.number.isRequired,
	    currentValue: _react.PropTypes.number.isRequired,
	    handleMouseDown: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dial = function (_React$Component) {
	    ...
	    function Dial() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Dial).apply(this, arguments));
	    }
	    ...
	    _createClass(Dial, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { onMouseDown: this.props.handleMouseDown, style: stylesLight },
	                _react2.default.createElement('div', { className: 'knob-lighting' }),
	                _react2.default.createElement('div', { className: 'knob', style: styles })
	            );
	        }
	    }]);
	...
	Dial.propTypes = {
	    ...
	    currentValue: _react.PropTypes.number.isRequired,
	    handleMouseDown: _react.PropTypes.func.isRequired,
	    extraStyles: _react.PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterPanel = function (_React$Component) {
	    ...
	    function FilterPanel(props) {
	        ...
	        _this._paintCurve = function (ctx) {
	            var y = _this.state.height / 2;
	            var resonanceStart = (_this.props.resonance + 130) / 2;
	            ctx.beginPath();
	            ctx.moveTo(0, y);
	    ...
	    _createClass(FilterPanel, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('canvas', { style: surfaceStyle, width: 300, height: this.state.height });
	        }
	    }]);
	...
	FilterPanel.propTypes = {
	    resonance: _react.PropTypes.number.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Volume = function (_React$Component) {
	    ...
	    function Volume() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Volume).apply(this, arguments));
	    }
	    ...
	    _createClass(Volume, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { style: faderWrapperStyle },
	                _react2.default.createElement('div', { className: 'faderSlit wide', style: { left: 'calc(50% - 3px)' } }),
	                _react2.default.createElement('div', { style: faderStyle, onMouseDown: this.props.handleMouseDown })
	            );
	        }
	    }]);
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'patch-selector' },
	                    _react2.default.createElement(
	                        'div',
	                        { onClick: this.props.incrementActivePatch },
	                        '+'
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { onClick: this.props.decrementActivePatch },
	                        '-'
	                    )
	                ),
	                _react2.default.createElement(
